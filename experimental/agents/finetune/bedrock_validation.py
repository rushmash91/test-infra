...
if __name__ == "__main__":
    import sys
    if len(sys.argv) < 2:
        print("Usage: python bedrock_validation.py <training_file> [validation_file]")
        sys.exit(1)
    
    training_file = sys.argv[1]
    validation_file = sys.argv[2] if len(sys.argv) > 2 else None
    
    validate_data(training_file, validation_file) 